            ...
            <form method="post">
              <div class="layui-form-item">
               ...
               <div class="layui-row">
                ...
                <div class="layui-input-inline">
                  <input type="text"   name="username" v-model.trim="username"    placeholder="请输入用户名"   autocomplete="off" class="layui-input">
                </div>
              ...
              <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                  ...
                  <input type="text"   name="nickname" v-model.trim="nickname"     placeholder="请输入昵称"  autocomplete="off" class="layui-input">
                </div>
              ...
              <div class="layui-form-item">
                ...
                <validation-provider name="cpassword" rules="required|min:6|max:16|is:${password}" v-slot="{errors}">
                <div class="layui-input-inline">
                  <input type="password"   name="cpassword" v-model.trim="cpassword"   placeholder="请再次输入密码"    autocomplete="off" class="layui-input">
                </div>
