<template>
  <div class="allPage">
    ...
    <div class="searchAll">
      ...
      <el-input v-model="searchPhone" placeholder="请输入姓名" class='search' size="mini"></el-input>
      ...
      <el-button type="" icon="el-icon-search" size='mini' @click='goBack' class="publicMidBtn">返回</el-button>
    </div>
    <div class="list">
...
<script>
import {preferentialPeopleList, basePropeSome} from '@/API'
export default {
  data: () => {
    return {
      userList: [],
  ...
  methods: {
    ...
    sureOut(i){
      ...
      let params = {};
      params.id = this.id;
      params.userId = this.multipleSelection.join(',')
      console.log(params);
      if(confirm('确认发放？')){
        basePropeSome(params).then(data=>{
